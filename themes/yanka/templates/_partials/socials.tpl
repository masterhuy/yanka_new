...
<ul id="social-links" class="social-links">
    ...
    {if isset($gdzSetting.social_twitter) && $gdzSetting.social_twitter != ''}
        <li class="twitter">
            <a class="social-icon social-twitter" href="{$gdzSetting.social_twitter}" target="_blank"><i class="la la-twitter" ></i></a>
        </li>
    {/if}
    ...
    {if isset($gdzSetting.social_vimeo) && $gdzSetting.social_vimeo != ''}
        <li class="vimeo">
            <a class="social-icon social-vimeo" href="{$gdzSetting.social_vimeo}" target="_blank"><i class="la la-vimeo" ></i></a>
        </li>
    {/if}
