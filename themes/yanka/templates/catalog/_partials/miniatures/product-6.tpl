 ...
 *}
<div class="product-miniature js-product-miniature thumbnail-container productbox-6" data-id-product="{$product.id_product}" data-id-product-attribute="{$product.id_product_attribute}" itemscope itemtype="http://schema.org/Product">
