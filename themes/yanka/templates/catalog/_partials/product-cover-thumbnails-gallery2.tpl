        ...
        <div class="js-qv-mask mask">
            <div id="gal1" class="product-imagess row">
                {foreach from=$product.images item=image}
                    <div class="col-12 thumb-container {if $image.id_image == $product.cover.id_image} selected {/if}" data-image="{$image.bySize.large_default.url}" data-zoom-image="{$image.bySize.large_default.url}">
                        <img
