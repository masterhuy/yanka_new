...
<div class="user-info position-relative">
	<a href="#" class="login hover-tooltip js-open-sidebar" data-toggle="dropdown" data-display="static">
	...
	{if $logged}
		<div id="login" class="dropdown-menu sidebar user-info-content {if $gdzSetting.customersignin_class}{$gdzSetting.customersignin_class}{/if}">
			<ul>
