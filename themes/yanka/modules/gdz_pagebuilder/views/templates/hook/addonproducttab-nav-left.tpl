...
<div class="pb-producttab addon-tab">
	<ul class="nav nav-tabs tab-left">
		...
		{if $producttabs.show_featured == '1'}
			<li class="nav-item"><a data-toggle="tab" href="#featured-{$unique_id}" class="nav-link active"><span>{$producttabs.featured_text}</span></a></li>
		{$cf = $cf + 1}
		{/if}
		{if $producttabs.show_new eq '1'}
			<li class="nav-item"><a data-toggle="tab" href="#latest-{$unique_id}" class="nav-link{if $cf eq 0} active{/if}"><span>{$producttabs.new_text}</span></a></li>
			{$cf = $cf + 1}
		{/if}
		{if $producttabs.show_topseller == '1'}
			<li class="nav-item"><a data-toggle="tab" href="#topseller-{$unique_id}" class="nav-link{if $cf eq 0} active{/if}"><span>{$producttabs.topseller_text}</span></a></li>
			{$cf = $cf + 1}
		{/if}
		{if $producttabs.show_special == '1'}
			<li class="nav-item"><a data-toggle="tab" href="#special-{$unique_id}" class="nav-link{if $cf eq 0} active{/if}"><span>{$producttabs.special_text}</span></a></li>
			{$cf = $cf + 1}
		{/if}
		{if $producttabs.show_onsale == '1'}
			<li class="nav-item"><a data-toggle="tab" href="#onsale-{$unique_id}" class="nav-link{if $cf eq 0} active{/if}"><span>{$producttabs.onsale_text}</span></a></li>
			{$cf = $cf + 1}
		{/if}
		<a class="link" href="index.php?id_category=68&controller=category&id_lang=1">{l s='All Products' d='Shop.Themes.Global'}</a>
	</ul>
