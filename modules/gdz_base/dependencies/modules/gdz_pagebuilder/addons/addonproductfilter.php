...
class gdzAddonProductFilter extends gdzAddonBase
{
    ...
    public function getProducts($fields)
    {
        ...
        $category_ids = array();
        if ($fields[1]->value) {
            $category_ids = explode(',', $fields[4]->value);
        }
    ...
    public function returnValue($addon)
    {
        ...
        $this->context->smarty->assign(
      			array(
      				...
      				'cols_sm'   => $cols_arr[1],
      				'cols_xs'   => $cols_arr[2],
      				'navigation' => $fields[7]->value,
      				'pagination' => $fields[8]->value,
      				'autoplay' => $fields[9]->value,
      				'rewind' => $fields[10]->value,
      				'slidebypage' => $fields[11]->value,
              'view_type' => $view_type,
