...
class gdzAddonBanner extends gdzAddonBase
{
    ...
    public function returnValue($addon)
    {
        ...
        $title = empty($addon->fields[3]->value->$id_lang) ? '' : gdzPageBuilderHelper::decodeHTML($addon->fields[3]->value->$id_lang);
        $description = empty($addon->fields[5]->value->$id_lang) ? '' : gdzPageBuilderHelper::decodeHTML($addon->fields[5]->value->$id_lang);
        $button_text = empty($addon->fields[6]->value->$id_lang) ? '' : gdzPageBuilderHelper::decodeHTML($addon->fields[6]->value->$id_lang);
        $this->context->smarty->assign(
            array(
                ...
                'subtitle'  => $subtitle,
                'title'  => $title,
                'title_tag'  => $addon->fields[4]->value,
                'description'  => $description,
                'button_text'  => $button_text,
                'banner_link' => $addon->fields[7]->value,
                'target' => $addon->fields[8]->value,
                'box_class' => $addon->fields[9]->value
            )
        );
