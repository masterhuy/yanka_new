            ...
            if(isset($cms[0]['link']))
              ...
              $item['link'] = '#';
                  ...
                  case 'jmspagebuilder-page':
                      include_once(_PS_MODULE_DIR_.'jmspagebuilder/jmspagebuilder.php');
                      $_page = GdzPageBuilderHelper::getPageByID($item['value']);
                      //print_r($_page); exit;
                      $_link = GdzPageBuilder::getPageLink('jmspagebuilder-page', array('id_page' => $_page['id_page'], 'slug' => $_page['alias']));
                      $item['link'] = $_link;
                      break;
                  case 'theme-logo':
                      $force_ssl = Configuration::get('PS_SSL_ENABLED') && Configuration::get('PS_SSL_ENABLED_EVERYWHERE');
