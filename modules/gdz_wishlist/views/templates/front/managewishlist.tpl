			...
			<li id="wlp_{$product.id_product}_{$product.id_product_attribute}" class="clearfix address {if $smarty.foreach.i.index % 2}alternate_{/if}item">
				...
				<div class="clearfix">
					...
					<div class="product_infos">
						...
						{/if}
							<br />{l s='Quantity' d='Shop.Theme.Global'}:<input type="text" id="quantity_{$product.id_product}_{$product.id_product_attribute}" value="{$product.quantity|intval}" class="form-control" size="3"  />
							<br /><br />
