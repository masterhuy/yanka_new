...
<script type="text/template" id="tmpl-btn-add-page-cms">
    <div class="form-group row">
        <label class="form-control-label">{l s='Pagebuilder - Add Page to Content' mod='gdz_pagebuilder'}</label>
        <div class="col-auto">
        ...
        <div class="col-auto">
          <a class="btn btn-primary add-page"><i class="icon-external-link"></i> {l s='Add' mod='gdz_pagebuilder'}</a>
        </div>
    </div>
</script>
