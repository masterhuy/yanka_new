...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  ...
  'unifunc' => 'content_60793f529e7937_57308656',
...
function content_60793f529e7937_57308656 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_loadInheritance();
$_smarty_tpl->inheritance->init($_smarty_tpl, false);
?>
<!-- begin E:\xampp7327\htdocs\yanka/themes/yanka/modules/productcomments/views/templates/hook/post-comment-modal.tpl -->
<?php echo '<script'; ?>
                    ...
                    <div class="row">
                        <div class="col-4">
                            <?php if (isset($_smarty_tpl->tpl_vars['product']->value) && $_smarty_tpl->tpl_vars['product']->value) {?>
                                <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_106810867760793f529c0275_28623409', 'product_flags');
?>


                                <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_86448422160793f529c5ce4_06465658', 'product_cover');
?>
                        ...
                        <div class="col-8">
                            ...
                            <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_94441371060793f529d0749_08496379', 'product_description_short');
?>
...
<sup class="required">*</sup></label>
                        ...
                        <?php } else { ?>
                            <div class="col-md-12 col-sm-12">
                                <label class="form-label" for="comment_title"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Body of Review','d'=>'Modules.Productcomments.Shop'),$_smarty_tpl ) );?>
<sup class="required">*</sup></label>
                            </div>
                        <?php }?>
                    </div>
                    ...
                    <div class="row">
                        <?php if (!$_smarty_tpl->tpl_vars['logged']->value) {?>
                            <div class="col-md-8 col-sm-8">
                                <input name="comment_title" placeholder="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Give your review a title','d'=>'Modules.Productcomments.Shop'),$_smarty_tpl ) );?>
" type="text" value=""/>
                            </div>
                            <div class="col-md-4 col-sm-4">
                                <input name="customer_name" placeholder="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Give your name','d'=>'Modules.Productcomments.Shop'),$_smarty_tpl ) );?>
" type="text" value=""/>
                            </div>
                        <?php } else { ?>
                            <div class="col-md-12 col-sm-12">
...
<sup class="required">*</sup></label>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <textarea placeholder="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Write your comments here','d'=>'Modules.Productcomments.Shop'),$_smarty_tpl ) );?>
...
?>
<!-- end E:\xampp7327\htdocs\yanka/themes/yanka/modules/productcomments/views/templates/hook/post-comment-modal.tpl --><?php }
/* {block 'product_flags'} */
class Block_106810867760793f529c0275_28623409 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'product_flags' => 
  array (
    0 => 'Block_106810867760793f529c0275_28623409',
  ),
);
...
/* {/block 'product_flags'} */
/* {block 'product_cover'} */
class Block_86448422160793f529c5ce4_06465658 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'product_cover' => 
  array (
    0 => 'Block_86448422160793f529c5ce4_06465658',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
class Block_94441371060793f529d0749_08496379 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'product_description_short' => 
  array (
    0 => 'Block_94441371060793f529d0749_08496379',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>

                                <div itemprop="description"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'truncate' ][ 0 ], array( $_smarty_tpl->tpl_vars['product']->value['description_short'],250,'...' ));?>
</div>
                            <?php
}
}
